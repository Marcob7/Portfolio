  ...
  <>
    ...
    <div name='ervaring' className='w-full h-screen bg-[#252525] text-gray-300 pt-8'>
        <div>
            ...
            {/*Container*/}
            <div className='max-w-[1000px] height-auto mx-auto p-4 pt-12 flex flex-col justify-center w-full h-full'>
                <div>
                ...
                <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-12'>
                   ...
                   <div className='mt-5'>
                    ...
                    <div class="mt-5 ml-8 grid gap-2 pb-2">
                        ...
                        <p>Front end developer - ICT888 en Digital experience (jan 2019 - heden)</p> 
                        </div>
                     </div> 
                     </div>
                    ...
                    <div class="mt-5 ml-8 grid gap-2 pb-2">
                        <div class="relative w-[400px] h-[50px]">
                        <h3><span class="text-base font-bold">Belastingdienst</span> <span class="text-xs"></span></h3>
                        <p>UX Designer - ICT888 en Digital experience (jan 2019 - heden)</p> 
                        </div>
                     </div>
                     </div>
                    ...
                    <div class="mt-5 ml-8 grid gap-2 pb-2">
                        ...
                        <p>Verkoopmedewerker en adviseur ktv en hifi (feb 2016 - feb 2018)</p> 
                        </div>
                     </div>
                     </div>
                    ...
                    <div class="mt-5 ml-8 grid gap-2 pb-2">
                        ...
                        <p>UX Designer - ICT888 en Digital experience (feb 2017 - juli 2017)</p> 
                        </div>
                     </div>
                     </div>
                    ...
                    <div class="mt-5 ml-8 grid gap-2 pb-2">
                        <div class="relative w-[400px] h-[50px]">
                        <h3><span class="text-base font-bold">Hogeschool van Arnhem en Nijmegen (HAN)</span> <span class="text-xs"></span></h3>
                        <p>Minor scripting for designers afgerond (sept 2017 - feb 2018)</p> 
                        </div>
                     </div>
                     </div>
                    ...
                    <div class="mt-5 ml-8 grid gap-2 pb-2">
                        ...
                        <p>Vestigingsmanager groot handel niveu 4 (sept 2011 - jun 2014)</p> 
                        </div>
                     </div>
                     </div>
